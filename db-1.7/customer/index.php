...
<li><a href="csv.php<?=$view->parameter(array('sort'=>$_GET['sort'], 'desc'=>$_GET['desc'], 'search'=>$_GET['search'], 'jufuku'=>$_GET['jufuku'], 'folder'=>$_GET['folder'], 'type'=>0))?>"<?=$attribute?>>宛名ダウンロード</a></li>
