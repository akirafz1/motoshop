...
<!--
<li><a href="csv.php<?=$view->parameter(array('sort'=>$_GET['sort'], 'desc'=>$_GET['desc'], 'jufuku'=>$_GET['jufuku'], 'folder'=>$_GET['folder'], 'type'=>0, 'cust_id'=>$cust_idt))?>"<?=$attribute?>>顧客一覧ダウンロード</a></li>
-->
